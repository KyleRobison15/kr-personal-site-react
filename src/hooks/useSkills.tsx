...
// const filterSkillsBySearchString = (searchString: string) => skills.filter((skill) => skill.label.toLowerCase().includes(searchString.toLowerCase()));
// const filterSkillsByCategory = (selectedCategory: string) => skills.filter((skill) => skill.categories.find((cat) => cat === selectedCategory));
// const filterSkillsBySearchAndCategory = (searchString: string, selectedCategory: string) => {
//   return skills
//     .filter((skill) =>
